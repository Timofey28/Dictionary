...
void Dictionary::print()
{
    ...
    while((choice = _getche()) != 13) {
        ...
        if(choice == -32) {
            ...
            else if(choice == 73 || choice == -115) { // PgUp
                if(!up) {
                    up = 1;
                    coord.Y = max(0, coord.Y - h + 1);
                }
            ...
            else if(choice == 81 || choice == -111) { // PgDn
                if(up) {
                    up = 0;
                    coord.Y = min(downY, coord.Y + h - 1);
                }
    ...
    if(w && h && dict.size() > h - 2) {
        ...
        while((choice = _getche()) != 13) {
            if(choice == -32 && _kbhit()) {
                ...
                else if(choice == 73 || choice == -115) { // page up
                    if(!up) {
                        up = 1;
                        coord.Y = max(0, coord.Y - h + 1);
                    }
                ...
                else if(choice == 81 || choice == -111) { // page down
                    if(up) {
                        up = 0;
                        coord.Y = min(downY, coord.Y + h - 1);
                    }
